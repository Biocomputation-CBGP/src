...
#Magicblast
command_magicblast = "magicblast -query all_reads_merged.txt -db Putida -out ./results_script_magicblast/all_seq_aligned.txt -outfmt tabular"
...
columns_seq_alig = ["query acc.", "reference start", "query strand","reference strand","BTOP", "% identity"]
